...
local themeTextures = {
    normal = {
        ...
        lights = "fantomitechno/fantomZippers/mouse/light01",
...
MouseZipper.name = "fantomZippers/MouseZipper"
MouseZipper.depth = -9999
MouseZipper.nodeVisibility = "never"
MouseZipper.nodeLimits = {1, 1}
MouseZipper.warnBelowSize = {16, 16}
MouseZipper.fieldInformation = {
    theme = {
        options = themes,
        editable = false
    }
}
MouseZipper.placements = {}

for i, theme in ipairs(themes) do
    MouseZipper.placements[i] = {
...
function MouseZipper.sprite(room, entity)
    local sprites = {}
...
function MouseZipper.selection(room, entity)
    local x, y = entity.x or 0, entity.y or 0
