...
local themeTextures = {
    normal = {
        ...
        lights = "fantomitechno/fantomZippers/microphone/light01",
...
MikeTheZipper.name = "fantomZippers/MicrophoneZipper"
MikeTheZipper.depth = -9999
MikeTheZipper.nodeVisibility = "never"
MikeTheZipper.nodeLimits = {1, 1}
MikeTheZipper.warnBelowSize = {16, 16}
MikeTheZipper.fieldInformation = {
    theme = {
        options = themes,
        editable = false
    }
}
MikeTheZipper.placements = {}

for i, theme in ipairs(themes) do
    MikeTheZipper.placements[i] = {
...
function MikeTheZipper.sprite(room, entity)
    local sprites = {}
...
function MikeTheZipper.selection(room, entity)
    local x, y = entity.x or 0, entity.y or 0
